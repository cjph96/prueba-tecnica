...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_annotation_metadata_driver'] ?? $container->load('getDoctrine_Orm_DefaultAnnotationMetadataDriverService')), 'App');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Service\\Processes\\Infraestructure\\ProcessDoctrineRepository' => ['privates', 'App\\Service\\Processes\\Infraestructure\\ProcessDoctrineRepository', 'getProcessDoctrineRepositoryService', true],
        ], [
            'App\\Service\\Processes\\Infraestructure\\ProcessDoctrineRepository' => '?',
        ])));
